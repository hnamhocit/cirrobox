...
import {CloudDownload, CloudDownloadIcon, MessageCircleIcon, Send, StarIcon,} from "lucide-react";
        ...
        <div className="space-y-12 py-12">
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <ProgressLink
                        href={`/@hnamhocit`}
                        className="py-1 px-3 font-semibold text-blue-500 bg-blue-500/10 rounded-xl"
                    >
                        @hnamhocit
                    </ProgressLink>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="py-1 px-3 text-pink-500 rounded-xl bg-pink-500/10 font-semibold">
                        https://github.com/hnamhocit/drive-cli
                    </div>
                </div>

                <div className="flex items-center gap-3">
                    <div className="font-semibold font-code">Categories</div>
                    <div className="flex items-center gap-3 flex-wrap">
                        <div className="text-sm rounded-xl py-1 px-3 shadow-md bg-neutral-900">Chat</div>
                        <div className="text-sm rounded-xl py-1 px-3 shadow-md bg-neutral-900">Messaging</div>
                        <div className="text-sm rounded-xl py-1 px-3 shadow-md bg-neutral-900">Online</div>
                    </div>
                </div>

                <div className="flex items-center gap-3">
                    <div className="font-semibold font-code">Languages</div>
                    <div className="py-1 px-3 font-semibold text-rose-500 rounded-xl bg-rose-500/10">
                        Rust, Bash, Makefile
                    </div>
                </div>
